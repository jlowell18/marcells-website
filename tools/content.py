...
METAL_WASTE = [
    ...
    ("h2", "Contact Us Now"),
    ("p", f"Marcells Paper and Metal INC is the right company to trust if you’re searching for a dependable recycler. Call us now at {PHONE_LINK} to use our metal waste collection and removal solutions in Chicago, IL!"),
]
...
PAGES = {
    ...
    "about": {"title": "About Us | Marcells Paper & Metal", "desc": "How Scott Lowell turned a trunk full of computer punch cards into Marcells Paper & Metal, Chicago's family-owned paper and metal recycler.", "h1": "Marcells Paper and Metal", "blocks": ABOUT},
    ...
    "metal-recycling": {"title": "Metal Recycling | Marcells Paper & Metal", "desc": "A reliable recycler for your metal waste collection and recycling needs in Chicago, IL.", "h1": "The Reliable Recycler for Your Metal Waste Collection and Recycling Needs", "blocks": METAL_RECYCLING},
